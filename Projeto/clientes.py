...
ClientesReg = namedtuple("clienteReg", "id, nome, morada, bi, carta_de_conducao")
listaclientes = []
...
def inserir_clientes():
    ...
    registo =ClientesReg(cod, nome, morada, bi, carta_de_conducao)
...
def listar_cliente():
    for i in range (len(listaclientes)):
        ...
        print listaclientes[i].nome.upper(),
        print listaclientes[i].morada.upper(),
        print "\t","bi",listaclientes[i].bi
        print        
        print "carta_de_conducao",listaclientes[i].carta_de_conducao
